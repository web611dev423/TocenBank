...
import SignUpState from "../stores/signup.store"
import "./sign-up.css"


export function SignUp() {
  const router = useRouter();
  const { setUsername, setEmail, setPassword } = SignUpState()
  ...
  return (
    <div className="flex w-full mx-auto">
      <div className="w-full tems-center flex justify-center md:w-1/2 p-6">
        <div className="max-w-[793px] max-h-[850px] mt-16 rounded-3xl p-8" style={{
          ...
          <div style={{ border: "2px solid rgb(0,102,255)",  background:"rgb(23, 37, 54)" }} className="p-10 rounded-3xl">
            <div className="flex justify-between gap-2">
              ...
              {/* <Image
              src="/svg/Salvador.png?height=24&width=40"
              alt="Salvador Flag"
              width={60}
              height={24}
              className="rounded"
            ...
            <p className="text-white mt-2 mb-6">Access the TOCENBANK how to offer with a single account</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="bg-[#05172C] h-[50px] border-[#374151] text-white"
                  />
                </div>
      ...
      <div className="hidden md:flex md:w-1/2 flex-col mt-40 items-center p-6">
        <QRCodeGenerator value={url} />
        <p className="text-sm text-white mt-10 mb-2">Scan QR code for SignUp</p>
        <h2 className="text-2xl font-bold text-white mb-6">Secure 2FA SignUp !</h2>
